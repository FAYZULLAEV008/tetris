...
const ROW = 24; // kattalashtirilgan
const COL = 16; // kattalashtirilgan
const SQ = 20;
const COLOR = [
  null,
  '#FF0D72',
...
function updateScore(){
    document.getElementById('score').innerText='Ball: '+player.score;
}
...
document.getElementById('up').addEventListener('click',()=>playerRotate(1));
